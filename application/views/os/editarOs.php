            ...
            <div class="widget-title" style="margin: -20px 0 0">
                ...
                <div class="buttons">
                    ...
                    <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eOs')) {
                        ...
                        $celnumber = preg_replace("/[^0-9]/", "", $result->celular_cliente);
                        ...
                        if (!empty($fonenumber)) {
                            echo '<a title="Via WhatsApp" class="button btn btn-mini btn-success" id="enviarWhatsApp" target="_blank" href="https://wa.me/send?phone=55' . $fonenumber . '&text=' . $texto_de_notificacao . '" ' . ($fonenumber == '' ? 'disabled' : '') . '>
                                <span class="button__icon"><i class="bx bxl-whatsapp"></i></span> <span class="button__text">WhatsApp Tel.</span>
                            </a>';
                        } 
                        if (!empty($celnumber)) {
                            echo '<a title="Via WhatsApp" class="button btn btn-mini btn-success" id="enviarWhatsApp" target="_blank" href="https://wa.me/send?phone=55' . $celnumber . '&text=' . $texto_de_notificacao . '" ' . ($celnumber == '' ? 'disabled' : '') . '>
                                <span class="button__icon"><i class="bx bxl-whatsapp"></i></span> <span class="button__text">WhatsApp Cel.</span>
                            </a>';
                        }
                    } ?>

<div class="row-fluid">
    <div id="footer" class="span12">
        <a class="pecolor" href="https://github.com/integratio-tecnologia/mapos" target="_blank">
            <?= date('Y') ?> &copy; INTEGRATIO Tecnologia - Map-OS - Versão: <?= $this->config->item('app_version') ?>
        </a>
    </div>
</div>
<!--end-Footer-part-->

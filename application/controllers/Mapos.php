    ...
    public function configurar()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $dataDotEnv = [
                ...
                'PAYMENT_GATEWAYS_EFI_CREDENTIAIS_SIGNATURE_SECRET' => $this->input->post('PAYMENT_GATEWAYS_EFI_CREDENTIAIS_SIGNATURE_SECRET'),
                ...
                'PAYMENT_GATEWAYS_MERCADO_PAGO_CREDENTIALS_SIGNATURE_SECRET' => $this->input->post('PAYMENT_GATEWAYS_MERCADO_PAGO_CREDENTIALS_SIGNATURE_SECRET'),
                ...
                'PAYMENT_GATEWAYS_ASAAS_CREDENTIAIS_WEBHOOK_TOKEN' => $this->input->post('PAYMENT_GATEWAYS_ASAAS_CREDENTIAIS_WEBHOOK_TOKEN'),
